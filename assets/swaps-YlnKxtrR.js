import{cB as P,dl as l,cE as w,cF as I,cG as A,cW as v,cN as h,cH as u,d0 as z,cT as R,cP as $,cY as M,dL as K,cU as F,cV as Q,cC as O,cD as H,e5 as L}from"./index-D-nQH_6X.js";import{S as r}from"./SwapController-CI922KkW.js";import"./index-rYLyapmj.js";const q={numericInputKeyDown(e,t,o){const n=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=e.metaKey||e.ctrlKey,i=e.key,a=i.toLocaleLowerCase(),c=a==="a",C=a==="c",V=a==="v",W=a==="x",E=i===",",_=i===".",N=i>="0"&&i<="9";!s&&(c||C||V||W)&&e.preventDefault(),t==="0"&&!E&&!_&&i==="0"&&e.preventDefault(),t==="0"&&N&&(o(i),e.preventDefault()),(E||_)&&(t||(o("0."),e.preventDefault()),(t?.includes(".")||t?.includes(","))&&e.preventDefault()),!N&&!n.includes(i)&&!_&&!E&&e.preventDefault()}},G=P`
  :host {
    width: 100%;
  }
