import{cM as v,cG as f,cH as a,cE as d,dl as w,dk as M}from"./index-D-nQH_6X.js";import{w as pe,s as me,a as he,p as ve,M as g,S as ee,R as l,r as E,A as j,e as te,c as ie,C as m,b as H,d as fe,f as k,E as q,O as T,g as V,h as F,i as $,j as D,T as ge,k as be,l as ye,m as xe}from"./core-CMFq3KTk.js";import{c as u,U as Ce}from"./index-pt5jn7zZ.js";import"./index.es-B63m2pZR.js";const p=ve({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),ke={state:p,subscribe(n){return he(p,()=>n(p))},subscribeKey(n,e){return me(p,n,e)},showTooltip({message:n,triggerRect:e,variant:t}){p.open=!0,p.message=n,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},A=pe(ke),oe={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await ee.isSIWXCloseDisabled()){g.shake();return}g.close()}},Se=v`
  :host {
    display: block;
