import{dL as x,ed as te,cP as c,cR as ne,cB as g,cC as j,cF as m,cG as b,cH as d,cE as l,dk as k,c_ as z,dl as u,cD as se,cW as f,cJ as D,di as L,e4 as le,dR as V,cT as U,dy as R,d2 as F,cM as ce,cQ as A,dN as T,e1 as q,dj as de,cL as ie,ee as ue,ef as he}from"./index-D-nQH_6X.js";import{P as _}from"./index-BQJ9F2LT.js";import{S as pe}from"./SwapController-CI922KkW.js";const oe={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){x.shake();return}if(await te.isSIWXCloseDisabled()){x.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&ne.disconnect(),x.close()}},me=g`
  :host {
    display: block;
